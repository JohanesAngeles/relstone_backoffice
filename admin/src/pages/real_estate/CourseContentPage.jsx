...
// Add to App.jsx: <Route path="/admin/course-content" element={<CourseContentPage />} />
// Add to sidebar nav under Real Estate section
...
// ── Course templates — all CE courses ────────────────────────────────────────
                    ...
                    return (
                      ...
                      >
                        ...
                        <p style={{ fontSize: 11, color: '#94a3b8', margin: '6px 0 0' }}>
                          {s.quiz?.length || 0} quiz questions
                        </p>
                      </button>
                    );
                  })}
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 8, flexWrap: 'wrap' }}>
                            ...
                            <input
                              ...
                              placeholder="Page ref (e.g. Page 2, Para 3)"
                            />
                          </div>
                        </div>
...
function TipTapEditor({ value, onChange }) {
  ...
  const toolbarBtn = (active, onClick, children, title) => (
    <button
      ...
      onClick={onClick}
      style={{
        background: active ? '#2EABFE' : '#f1f5f9',
