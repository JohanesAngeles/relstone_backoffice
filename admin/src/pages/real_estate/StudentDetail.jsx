...
const sr = {
  ...
  infoCardHeader:  { display: 'flex', alignItems: 'center', gap: 6, padding: '10px 16px', borderBottom: '0.5px solid #5B7384', fontSize: 12, fontWeight: 500, color: '#091925', textTransform: 'capitalize', fontFamily: "'Poppins', sans-serif" },
