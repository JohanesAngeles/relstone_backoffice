...
// ── SVG Icon helper (matches admin AppLayout exactly) ────────────────────────
...
const STUDENT_NAV = [
  ...
  },
  {
    ...
    items: [
      {
        label: "R.E. Course Material",
        sub: "Self Study PDFs — Real Estate",
        to: "/course-material/real-estate",
        icon: "M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z",
      },
      {
        label: "Insurance & CFP Mate...",
        sub: "Self Study PDFs — Ins. & CFP",
        to: "/course-material/insurance-cfp",
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: 18, fontWeight: 700, color: "#091925", marginBottom: 8, fontFamily: "'Poppins', sans-serif" }}>
          Sign Out?
        </h2>
        <p style={{ fontSize: 13, color: "#64748b", lineHeight: "1.6", marginBottom: 24, fontFamily: "'Poppins', sans-serif" }}>
...
function Sidebar() {
  ...
  const ALL_ROUTES = useMemo(
    () =>
      STUDENT_NAV.flatMap((g) =>
        g.items.map((it) => ({ section: g.section, label: it.label, sub: it.sub, to: it.to }))
      ),
    []
  );
  ...
  const searchResults = useMemo(() => {
    ...
    return ALL_ROUTES.filter((r) =>
      `${r.section} ${r.label} ${r.sub}`.toLowerCase().includes(q)
    ).slice(0, 10);
  }, [q, ALL_ROUTES]);

  // Close search on ESC / outside click
  useEffect(() => {
  ...
  return (
    <>
      ...
      <aside style={{
        ...
        {/* ── Controls: hamburger + search ── */}
        <div style={{
          display: "flex", alignItems: "center",
          padding: "12px 16px",
          borderBottom: "1px solid #f1f5f9",
          minHeight: 52, gap: 10, flexShrink: 0,
        }}>
          <button
            onClick={() => setOpen((v) => !v)}
            style={{
              background: "none", border: "none", color: "#163347",
          ...
          {open && (
            <div
              data-side-search="1"
              style={{
                position: "relative", flex: 1, marginLeft: 6,
                display: "flex", alignItems: "center",
            ...
            >
              ...
              {navSearch && (
                <button
                  onClick={() => { setNavSearch(""); setSearchOpen(false); }}
                  style={{
              ...
              {searchOpen && (
                <div style={{
                  ...
                  {searchResults.length === 0 ? (
                    <div style={{ padding: "12px", fontSize: 12, color: "#64748b", fontFamily: "'Poppins', sans-serif" }}>
                      No results found.
                    </div>
                  ) : searchResults.map((r) => (
                    <button
                      key={r.to}
                      className="stu-search-result"
                      onClick={() => { navigate(r.to); setNavSearch(""); setSearchOpen(false); }}
                      style={{
        ...
        <nav style={{ flex: 1, overflowY: "auto", paddingBottom: 8 }}>
          {STUDENT_NAV.map((group, gi) => (
            <div key={group.section} style={{ marginTop: gi > 0 ? 8 : 0 }}>
              ...
              {gi > 0 && open && (
                <div style={{
                  width: "calc(100% - 60px)", height: "0.5px",
                  background: "#7FA8C4", margin: "6px 12px", opacity: 0.4,
                }} />
              )}

              {open && (
                <p style={{
                  fontSize: 9, fontWeight: 700, color: "#7FA8C4",
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      minHeight: 52,
                      background: isActive ? "#ECF7FF" : "transparent",
                      justifyContent: open ? "flex-start" : "center",
                      padding: open ? "10px 16px 10px 0" : "10px 0",
                    }}
                  >
                    {/* Blue left accent */}
                    {isActive && open && (
                    ...
                    <span
                      ...
                      style={{
                        ...
                        marginLeft: open ? 10 : "auto",
                        marginRight: open ? 0 : "auto",
                      }}
                    >
                      <span
                        className="stu-nav-icon"
                        style={{
                          display: "flex",
                    ...
                    {open && (
                      <div style={{ flex: 1, minWidth: 0, marginLeft: 9 }}>
                        ...
                        <p style={{
                          fontSize: 12, color: "#7FA8C4", margin: 0, marginTop: 1,
                          whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",
        ...
        {open ? (
          <div style={{ padding: "8px 12px 12px", flexShrink: 0 }}>
            <button
              ...
              className="stu-signout-btn"
              style={{
                display: "flex", alignItems: "center", gap: 10,
                width: "100%", background: "#f8fafc",
                border: "1px solid #e2e8f0", borderRadius: 8,
                padding: "8px 12px", height: 56, cursor: "pointer",
...
function UserPill({ user }) {
  ...
  return (
    <>
      <div ref={ref} style={{ position: "relative" }}>
        ...
        >
          <div style={{
            ...
            background: "#F59E0B",
            display: "flex", alignItems: "center", justifyContent: "center",
            color: "#091925", fontWeight: 800, fontSize: 12, flexShrink: 0,
          }}>
            {getInitials(user)}
          </div>
        ...
        {open && (
          <div style={{
            ...
            <div style={{ padding: "14px 16px", borderBottom: "0.5px solid #1e293b" }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: "#f1f5f9", letterSpacing: 0.1 }}>
      ...
      {showSignOut && (
        <div style={{
          position: "fixed", inset: 0, background: "rgba(9,25,37,0.75)",
          display: "flex", alignItems: "center", justifyContent: "center",
          zIndex: 9999, padding: 20,
        }}>
          <div style={{
            background: "#0f172a", border: "0.5px solid #334155",
            borderRadius: 10, padding: "32px 28px", maxWidth: 380, width: "100%",
            ...
            <div style={{
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                <path d="M9 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3H9" stroke="#ef4444" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                <polyline points="16 17 21 12 16 7" stroke="#ef4444" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                <line x1="21" y1="12" x2="9" y2="12" stroke="#ef4444" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
              <button
                ...
                style={{
                  ...
                  border: "0.5px solid #334155", borderRadius: 6, color: "#94a3b8",
                  fontSize: 13, fontWeight: 600, cursor: "pointer",
                }}
                onMouseEnter={(e) => e.currentTarget.style.background = "#1e293b"}
                onMouseLeave={(e) => e.currentTarget.style.background = "transparent"}
              ...
              <button
                ...
                style={{
                  ...
                  border: "0.5px solid #ef4444", borderRadius: 6, color: "#fff",
                  fontSize: 13, fontWeight: 600, cursor: "pointer",
                }}
    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", minWidth: 190 }}>
        ...
        <div style={{ display: "none", alignItems: "center", gap: 10 }}>
          <div style={{
            width: 36, height: 36, background: "#fff", borderRadius: 6,
            display: "flex", alignItems: "center", justifyContent: "center",
            fontWeight: 900, fontSize: 12, color: "#1e293b", letterSpacing: -0.5, flexShrink: 0,
          }}>RC</div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 18, marginLeft: "auto" }}>
        <button style={{
          ...
          color: "#94a3b8", fontSize: 19, padding: 0,
          display: "flex", alignItems: "center",
        }}>
          <FaShoppingCart />
        </button>
    ...
    <div style={{
      ...
      <div>
        <div style={{ fontSize: 22, fontWeight: 800, color: "#f1f5f9" }}>
          {getGreeting()},{" "}
          <span style={{ color: "#38bdf8" }}>{getFirstName(user)}!</span>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <FaCircle style={{ fontSize: 7, color: "#22c55e" }} /> Examination Server
          </span>
          <span style={{ color: "#334155" }}>•</span>
          <span style={{ display: "flex", alignItems: "center", gap: 5 }}>
            <FaCircle style={{ fontSize: 7, color: "#22c55e" }} /> Online
          </span>
          <span style={{ color: "#334155" }}>•</span>
          <span>P.S.T.</span>
        </div>
...
function Footer() {
  return (
    <div style={{
      borderTop: "1px solid #e5e7eb", padding: "13px 24px",
      ...
      <div style={{ fontSize: 11, color: "#9ca3af", fontFamily: "monospace", letterSpacing: 0.5 }}>
